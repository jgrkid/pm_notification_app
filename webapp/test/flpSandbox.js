		...
		services: {
						...
						"groups": [{
							"tiles": [{
								...
								"properties": {
									...
									"targetURL": "#pmnotificationapp-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"pmnotificationapp-display": {
								"semanticObject": "pmnotificationapp",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=pmnotificationapp",
									"url": sap.ui.require.toUrl("pmnotificationapp")
								}
							}
						}
					}
